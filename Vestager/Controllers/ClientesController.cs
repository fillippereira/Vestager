...
namespace Vestager.MVC.Controllers
{
    public class ClientesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,Nome,Nascimento,Sexo,Telefone,RG,CPF,Email,Endereco,Bairro,Cidade,Estado,CEP")] Cliente cliente)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ClienteExists(cliente.UserID))
                    {
                        return NotFound();
                    }
                    else
